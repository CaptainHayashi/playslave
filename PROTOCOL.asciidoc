...
+ejct+::
    ...
    audio file *MUST* be destroyed.  Ejecting whilst *Ejct* *MAY*
    produce an illegal state error.
+
.Example of +ejct+ when *Play*
================================================================================
    --> ejct
    <-- STAT Play Ejct
    <-- OKAY ejct
...
+TIME+ _timestamp_::
    If +playslave+ is *Play*, this is (its estimate of) the current
